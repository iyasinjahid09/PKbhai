...
EXEMPTED_USERS = [1917682089, 1604629264]
...
def reset_attack_limit(message):
    owner_id = 1908670857  # Replace with the actual owner ID
...
FEEDBACK_CHANNEL_ID = "-1002663322339"  # Replace with your actual feedback channel ID
