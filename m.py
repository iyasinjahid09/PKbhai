...
TOKEN = '7274723113:AAEdIv_UzFLN0zVw4_Bpq3RVmy0TYyGbCHo'  # Replace with your actual bot token
ADMIN_IDS = [1917682089]  # Added new admin ID
CHANNEL_ID = '-2367290757'  # Replace with your specific channel or group ID
# Initialize the bot
...
EXEMPTED_USERS = [1079846534, 16046]
...
def reset_attack_limit(message):
    owner_id = 1917682089  # Replace with the actual owner ID
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [PK CHOPRA](https://t.me/@Pk_Chopra) ⚡*"
    )
...
FEEDBACK_CHANNEL_ID = "-2215875563"  # Replace with your actual feedback channel ID
